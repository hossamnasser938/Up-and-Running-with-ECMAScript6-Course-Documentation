...
* ` fetch ` just takes as arguments the **path to the resource you wanna get** or simply the **URL** and returns the **response**.
...
## Async and await
* ` async ` and ` await ` keywords are used to define **asynchronous functions**.
